...
class CheckoutValidationPage(BasePage):
    ...
    def __init__(self, driver):
        ...
        # Locators
        self.proceed_to_checkout_btn = (By.XPATH, "//a[contains(translate(text(), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'proceed')]")
        ...
        self.error_messages = (By.CSS_SELECTOR, ".error-message, .woocommerce-error li, span.error")
    ...
    def click_proceed_to_checkout(self):
        """Clicks the 'Proceed Checkout' button on the cart page."""
        proceed_btn = self.wait.until(EC.presence_of_element_located(self.proceed_to_checkout_btn))
    ...
    def fill_all_required_details(self, first_name, last_name, address, city, postcode, phone, email):
    ...
    def clear_address_field(self):
        addr_field = self.wait.until(EC.presence_of_element_located(self.address))
        addr_field.clear()
    ...
    def get_validation_errors(self):
        time.sleep(1) # Wait for DOM update on errors
